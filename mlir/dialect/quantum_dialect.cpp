...
namespace mlir {
namespace quantum {
bool isOpaqueTypeWithName(mlir::Type type, std::string dialect, std::string type_name) {
...
::mlir::Value ExtractQubitOp::qbit() {
  return *getODSResults(0).begin();
}

void ExtractQubitOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::Type qbit, ::mlir::Value qreg, ::mlir::Value idx) {
  odsState.addOperands(qreg);
  odsState.addOperands(idx);
  odsState.addTypes(qbit);
}

void ExtractQubitOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, ::mlir::TypeRange resultTypes, ::mlir::Value qreg, ::mlir::Value idx) {
  odsState.addOperands(qreg);
  odsState.addOperands(idx);
...
::mlir::LogicalResult ExtractQubitOp::verify() {
  if (failed(ExtractQubitOpAdaptor(*this).verify(this->getLoc()))) return ::mlir::failure();
  {
    ...
    for (::mlir::Value v : valueGroup0) {
      (void)v;
      if (!(((v.getType().isa<::mlir::VectorType>())) && ((isOpaqueTypeWithName(v.getType().cast<::mlir::ShapedType>().getElementType(), "quantum", "Qubit"))))) {
        return emitOpError("operand #") << index << " must be vector of opaque qubit type values, but got " << v.getType();
      }
      ++index;
    }
  ...
  }
  {
    ...
    for (::mlir::Value v : valueGroup0) {
      ...
      if (!((isOpaqueTypeWithName(v.getType(), "quantum", "Qubit")))) {
        return emitOpError("result #") << index << " must be opaque qubit type, but got " << v.getType();
      }
      ++index;
    }
  }
...
void InstOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Type bit, ::mlir::StringAttr name, ::mlir::ValueRange qubits, /*optional*/::mlir::DenseElementsAttr params) {
...
void InstOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, /*optional*/::mlir::Type bit, ::llvm::StringRef name, ::mlir::ValueRange qubits, /*optional*/::mlir::DenseElementsAttr params) {
  odsState.addOperands(qubits);
...
::mlir::LogicalResult InstOp::verify() {
  if (failed(InstOpAdaptor(*this).verify(this->getLoc()))) return ::mlir::failure();
  {
    ...
    for (::mlir::Value v : valueGroup0) {
      (void)v;
      if (!((isOpaqueTypeWithName(v.getType(), "quantum", "Qubit")))) {
        return emitOpError("operand #") << index << " must be opaque qubit type, but got " << v.getType();
      }
      ++index;
    }
  }
  {
    ...
    for (::mlir::Value v : valueGroup0) {
      ...
      if (!((isOpaqueTypeWithName(v.getType(), "quantum", "Result")))) {
        return emitOpError("result #") << index << " must be opaque result type, but got " << v.getType();
      }
      ++index;
    }
  }
...
::mlir::LogicalResult QallocOp::verify() {
  ...
  }
  {
    ...
    for (::mlir::Value v : valueGroup0) {
      (void)v;
      if (!(((v.getType().isa<::mlir::VectorType>())) && ((isOpaqueTypeWithName(v.getType().cast<::mlir::ShapedType>().getElementType(), "quantum", "Qubit"))))) {
        return emitOpError("result #") << index << " must be vector of opaque qubit type values, but got " << v.getType();
      }
      ++index;
    }
  }
