...
public:
  enum {
    ...
    T__86 = 87, LBRACKET = 88, RBRACKET = 89, LBRACE = 90, RBRACE = 91, 
    LPAREN = 92, RPAREN = 93, COLON = 94, SEMICOLON = 95, DOT = 96, COMMA = 97, 
    EQUALS = 98, ARROW = 99, MINUS = 100, Constant = 101, Whitespace = 102, 
    Newline = 103, Integer = 104, Identifier = 105, RealNumber = 106, TimingLiteral = 107, 
    StringLiteral = 108, LineComment = 109, BlockComment = 110
  };
  ...
  enum {
    ...
    RuleQuantumGateName = 51, RuleUnaryOperator = 52, RuleBinaryOperator = 53, 
    RuleExpressionStatement = 54, RuleExpression = 55, RuleExpressionTerminator = 56, 
    RuleExpressionList = 57, RuleBuiltInCall = 58, RuleBuiltInMath = 59, 
    RuleCastOperator = 60, RuleIncrementor = 61, RuleEqualsExpression = 62, 
    RuleAssignmentOperator = 63, RuleEqualsAssignmentList = 64, RuleMembershipTest = 65, 
    RuleSetDeclaration = 66, RuleProgramBlock = 67, RuleBranchingStatement = 68, 
    RuleLoopSignature = 69, RuleLoopStatement = 70, RuleControlDirectiveStatement = 71, 
    RuleControlDirective = 72, RuleKernelDeclaration = 73, RuleKernelCall = 74, 
    RuleSubroutineDefinition = 75, RuleReturnStatement = 76, RuleSubroutineBlock = 77, 
    RuleSubroutineCall = 78, RulePragma = 79, RuleTimingType = 80, RuleTimingBox = 81, 
    RuleTimingTerminator = 82, RuleTimingIdentifier = 83, RuleTimingInstructionName = 84, 
    RuleTimingInstruction = 85, RuleTimingStatement = 86, RuleCalibration = 87, 
    RuleCalibrationGrammarDeclaration = 88, RuleCalibrationDefinition = 89, 
    RuleCalibrationGrammar = 90, RuleCalibrationArgumentList = 91
  };
