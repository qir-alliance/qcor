...
public:
  ...
  virtual antlrcpp::Any visitCompute_action_stmt(qasm3Parser::Compute_action_stmtContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitRelationalOperator(qasm3Parser::RelationalOperatorContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitBooleanExpression(qasm3Parser::BooleanExpressionContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitComparsionExpression(qasm3Parser::ComparsionExpressionContext *ctx) override {
    return visitChildren(ctx);
  }
