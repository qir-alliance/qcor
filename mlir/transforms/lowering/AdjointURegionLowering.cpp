 ...
 *******************************************************************************/
#include "AdjointURegionLowering.hpp"
...
namespace qcor {
LogicalResult StartAdjointURegionOpLowering::matchAndRewrite(
...
LogicalResult EndAdjointURegionOpLowering::matchAndRewrite(
    Operation *op, ArrayRef<Value> operands,
    ConversionPatternRewriter &rewriter) const {
  // Local Declarations
  ModuleOp parentModule = op->getParentOfType<ModuleOp>();
